...
function Header() {
  return (
    ...
    <header className="bg-white text-gray-900 py-6">
      <div className="container mx-auto flex items-center justify-between py-4">
        <div className="flex items-center">
          <Link to="/">
            <img src="/stalogo.png" alt="Logotipo" className="h-16" />
          </Link>
        </div>
        ...
        <nav className="flex justify-center flex-grow">
          <ul className="flex space-x-4 text-xl">
            ...
            <li><Link to="/about" className=" hover:bg-black hover:text-white px-4 py-2 rounded-lg">Chapéus-Gorros</Link></li>
